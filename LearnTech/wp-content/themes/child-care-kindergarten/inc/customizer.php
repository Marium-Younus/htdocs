...
function child_care_kindergarten_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('child_care_kindergarten_site_title_fontsize',array(
		'default' => '',
		'sanitize_callback'	=> 'child_care_kindergarten_sanitize_float'
	));
	$wp_customize->add_control('child_care_kindergarten_site_title_fontsize',array(
		'type' => 'number',
		'label' => __('Site Title Font Size','child-care-kindergarten'),
		'section' => 'title_tagline',
	));
	...
	$wp_customize->add_setting('child_care_kindergarten_site_tagline_fontsize',array(
		'default' => '',
		'sanitize_callback'	=> 'child_care_kindergarten_sanitize_float'
	));
	$wp_customize->add_control('child_care_kindergarten_site_tagline_fontsize',array(
		'type' => 'number',
		'label' => __('Site Tagline Font Size','child-care-kindergarten'),
		'section' => 'title_tagline',
	));
	...
	$wp_customize->add_setting('child_care_kindergarten_hide_show_topbar',array(
    	'default' => false,
    	'sanitize_callback'	=> 'child_care_kindergarten_sanitize_checkbox'
	));
	$wp_customize->add_control('child_care_kindergarten_hide_show_topbar',array(
   	'type' => 'checkbox',
   	'label' => __('Show / Hide Topbar','child-care-kindergarten'),
