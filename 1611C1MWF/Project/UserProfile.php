...
<div class="row">
<div class="col-md-12">
<h2 style="text-align:center; font-family:'Cormorant Unicase', serif; font-size:50px;font-weight:bold;">User Profile</h2>
</div>
</div>
...
<div class="col-md-4">
<img src="HomeDesign/images/<?php echo $_SESSION["img"]?>" style="border:medium; border-color:#000; width:250px; height:250px;" />

<br />
<br />


<h4 style="margin-left:100px;"><?php echo $_SESSION["un"]?></h4>
</div>

<div class="col-md-1"></div>
<div class="col-md-5">
<h4>Email</h4>
<p style="margin-left:50px;"><?php echo $_SESSION["email"]?></p>
<br />
<h4>Phone</h4>
<p style="margin-left:50px;"><?php echo $_SESSION["ph"]?></p>
<br />
<h4>Gender</h4>
<p style="margin-left:50px;"><?php echo $_SESSION["gender"]?></p>
<br />
...
<div class="container-fluid gallery-lightbox my-5" style="background-image:url(HomeDesign/images/back0.jpg);">
<br />
            <div class="row m-0">

       <?php
									$querys = mysqli_query($connection,"select * from user_picture");
...
<div class="row">
<div class="col-md-12">
<h2 style="text-align:center; font-family:'Cormorant Unicase', serif; font-size:36px;font-weight:bold;">User Profile</h2>
</div>
</div>
...
<div class="col-md-2"></div>
<div class="col-md-4">
<img src="HomeDesign/images/1.jpg" class="img-thumbnail"/>

<br />
<br />


<h4 style="margin-left:120px;">Bella</h4>
</div>

<div class="col-md-1"></div>
<div class="col-md-5">
<h4>Email</h4>
<p style="margin-left:50px;">Bella@Hotmail.com</p>
<br />
<h4>Phone</h4>
<p style="margin-left:50px;">090078601</p>
<br />
<h4>Gender</h4>
<p style="margin-left:50px;">Male</p>
<br />
...
<div class="row">
<div class="col-md-12">
<h2 style="font-family:'Cormorant Unicase', serif; font-size:30px;margin-left:50px;;">User Pictures</h2>
</div>
</div>

<div class="row">
<div class="col-md-4"><img src="HomeDesign/images/2.jpg" class="img-thumbnail"/></div>
<div class="col-md-4"><img src="HomeDesign/images/3.jpg" class="img-thumbnail"/></div>
<div class="col-md-4"><img src="HomeDesign/images/4.jpg" class="img-thumbnail"/></div>
</div>
