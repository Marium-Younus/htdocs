...
<div class="container">
    <?php echo form_open("Home/editrecord/{$col->id}",['class'=>'form-horizontal'])?>
    <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <?php echo form_input(['name'=>'customername','class'=>'form-control',
                                'placeholder'=>'Enter Customer name','value'=>set_value('customername',$col->customername)])?>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        ...
        'placeholder'=>'Enter Phone number','value'=>set_value('Phone',$col->Phone)])?>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <?php echo form_input(['name'=>'Address','class'=>'form-control','placeholder'=>'Enter Address','value'=>set_value('Address',$col->Address)])?>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <?php echo form_input(['name'=>'city','class'=>'form-control','placeholder'=>'Enter Cty','value'=>set_value('city',$col->City)])?>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <?php echo form_input(['name'=>'country','class'=>'form-control','placeholder'=>'Enter Country','value'=>set_value('country',$col->Country)])?>
