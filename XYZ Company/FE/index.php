...
<body>
  ...
  include("config.php");
			 $query = mysqli_query($connection,"Select * from BannerTable");
  ...
  ?> 
   <div class="carousel-item active">
      <img class="d-block w-100" src="Burgerimages/<?php echo  $row["B_Image"] ?>" alt="First slide">
    </div>
   <?php
							}}
   ?>
    ...
    <div class="best_burgers_area">
        <div class="container">
           ...
           <div class="row">
            <?php
			include("config.php");
			 $query = mysqli_query($connection,"Select * from producttable");
						if( mysqli_num_rows($query) > 0)
						{
							while ($row = mysqli_fetch_array($query))
							{	
			?>
                ...
                <div class="col-xl-6 col-md-6 col-lg-6">
                    <div class="single_delicious d-flex align-items-center">
                        <div class="thumb">
                            <img src="Burgerimages/<?php echo  $row["Pro_Image"] ?>" alt="">
                        </div>
                        <div class="info">
